...
const TechNews: React.FC = () => {
    ...
    const fetchCategory = async () => {
        try {
            ...
            console.log("Cateogry1: ", data.docs[3]);
            setCategory(data.docs[3]);
        } catch (error) {
    ...
    console.log("Tech News Blogs:", blogs);
    ...
    return (
        <div className="side">
            {category && blogs.length > 0 && (
                <div className="max-w-screen-2xl mx-auto lg:pb-14 lg:pt-20 pt-16">
